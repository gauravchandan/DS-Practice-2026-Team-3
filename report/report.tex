...
1. National Demographic Overview
2. State Comparisons
3. District Explorer
...
\subsection{Predictive Indexing: Composite Demographic Health Index}
...
The full project repository containing datasets, clearing scripts, and Streamlit application is available locally.
