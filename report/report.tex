...
The full project repository is available on \href{https://github.com/gauravchandan/DS-Practice-2026-Team-3}{Github} and the interactive dashboard can be accessed on \href{https://indiametrics.streamlit.app}{Streamlit Community Cloud}.
